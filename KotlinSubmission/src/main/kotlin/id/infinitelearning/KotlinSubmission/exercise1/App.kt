 ...
 */
fun myProfile() {
    val namaDepan = "Aristo"
    val namaBelakang = "Demos"
    val umur: Byte = 22
    val status = true //kalau true -> single, false -> taken
...
fun myName(): String {
    ...
    val anggotaGroup = arrayOf("Adellina Sylvira Azis", "Ahmad Darma Wijaya Atenza", "Aristo Demos", "Excelsis Deo Lukow", "Icha Sinaga")
